...
This file captures the repository conventions for `guzzlehttp/guzzle-services`.
...
- `2.0` is the unreleased next major version and `1.7` is the current stable
...
[security policy](https://github.com/guzzle/guzzle-services/security/policy)
instead.
