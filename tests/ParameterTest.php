...
class ParameterTest extends TestCase
{
    ...
    {
        return [
            ['name', [], 'name must be a string or null; got array.'],
            ['required', [], 'required must be a boolean; got array.'],
            ['static', new \stdClass(), 'static must be a boolean; got stdClass.'],
            ['minimum', 'abc', 'minimum must be an integer or null; got string.'],
            ['maxItems', 1.5, 'maxItems must be an integer or null; got float.'],
            ['minimum', true, 'minimum must be an integer or null; got bool.'],
            ['filters', true, 'filters must be an array; got bool.'],
            ['filters', [true], 'Filters must be strings or complex filter arrays; got bool.'],
            ['filters', [['method' => 'strtolower', 'args' => 'bad']], 'An [args] array must be specified for each complex filter; got string.'],
            ['properties', 'foo', 'properties must be an array; got string.'],
            ['properties', ['foo' => true], 'properties must contain only arrays or Parameter instances; got bool.'],
            ['data', 'foo', 'data must be an array; got string.'],
            ['enum', 'foo', 'enum must be an array or null; got string.'],
            ['additionalProperties', 'foo', 'additionalProperties must be a boolean, array, Parameter, or null; got string.'],
            ['items', 'foo', 'items must be an array, Parameter, or null; got string.'],
            ['type', true, 'type must be a string, array, or null; got bool.'],
            ['type', [true], 'type arrays must contain only strings; got bool.'],
        ];
    }
